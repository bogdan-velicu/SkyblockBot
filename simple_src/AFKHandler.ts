import { ScoreBoard, Bot } from "mineflayer";
import { printMcChatToConsole, log } from "./logger";
import { sleep } from "./utils";

export function initAFKHandler(bot: Bot) {
...
export async function tryToTeleportToIsland(
  bot: Bot,
  ...
  let scoreboard = bot.scoreboard.sidebar.items.map((item) =>
